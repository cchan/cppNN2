...
class CMakeBuild(build_ext):
    ...
    def build_extension(self, ext):
        ...
        test_bin = os.path.join(self.build_temp, 'cppNN_test')
...
setup(
    ...
    description='Neural networks in C++ with Python bindings.',
    long_description='',
    packages=find_packages('src'),
    package_dir={'':'src'},
    ext_modules=[CMakeExtension('cppNN/cppNN')],
